...
class rtAffiliatePaymentList extends WP_List_Table {
    ...
    function column_action( $row ) { ?>
        <a href="?page=rt-affiliate-manage-payment&action=edit&pid=<?php echo $row->id; ?>">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class='rtAff-delete-payment' href="#" data-href="?page=rt-affiliate-manage-payment&action=delete&pid=<?php echo $row->id; ?>">Delete</a>
    <?php }
